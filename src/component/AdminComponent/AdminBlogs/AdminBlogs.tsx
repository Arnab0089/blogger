...
const AdminBlogs: React.FC<AdminBlogsProps> = ({ currentBlogId, author }) => {
  ...
  useEffect(() => {
    ...
    if (author) fetchBlogs();
  }, [author, currentBlogId]);

  return (
    <div className="w-full px-6 md:px-20 my-10">
      <h2 className="text-2xl font-bold mb-6 font-family-primary">
        More by {author}
      </h2>
