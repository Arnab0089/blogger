  ...
  return (
    <div className="flex justify-between px-4 py-2 bg-bg-light-primary shadow-2xs  w-full">
      ...
      <div className=" items-center space-x-4 hidden md:flex">
        <Link href={'/blog-list'}>
          <button className="flex gap-2 font-family-primary border-2 border-gray-300 rounded-lg px-4 py-2 bg-bg-light-primary text-font-secondary hover:bg-gray-100 transition duration-300 shadow-[-7px_7px_0px] cursor-pointer w-full font-extrabold items-center justify-center">
